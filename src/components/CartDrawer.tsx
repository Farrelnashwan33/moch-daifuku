  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-6 sm:pl-10">
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col justify-between overflow-hidden animate-slideInRight">
          
          {/* Header */}
          <div className="px-6 py-4.5 bg-cream-100 border-b border-cream-300 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-coral-500 text-white flex items-center justify-center shadow-coral">
                <ShoppingBag className="w-5 h-5" />
              </div>
              <div>
                <h3 className="font-display font-black text-lg text-choco-900 leading-tight">
                  Keranjang Belanja
                </h3>
            ...
            <button
              ...
              className="p-2 rounded-xl text-choco-500 hover:text-choco-900 hover:bg-cream-200 transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
            ...
            {items.length === 0 ? (
              <div className="py-16 text-center flex flex-col items-center">
                <div className="w-20 h-20 rounded-3xl bg-cream-200 text-coral-400 flex items-center justify-center text-4xl mb-4">
                  🍰
                </div>
                <h4 className="font-display font-bold text-lg text-choco-900">
                  Keranjangmu Masih Kosong
                </h4>
                <p className="text-xs text-choco-600 mt-1 max-w-xs">
                  Yuk pilih Mochi Daifuku atau dessert manis kesukaanmu sekarang!
                </p>
                <button
                  onClick={closeCart}
                  className="mt-6 px-6 py-3 rounded-2xl bg-coral-500 hover:bg-coral-600 text-white font-bold text-xs shadow-coral transition-all"
                >
                  Lihat Menu
                </button>
              </div>
              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  {items.map((item) => (
                    <div
                      key={item.id}
                      className="bg-cream-50/80 rounded-2xl p-3 border border-cream-300 flex items-center gap-3 hover:border-coral-200 transition-colors"
                    >
                      <div className="relative w-13 h-13 rounded-xl overflow-hidden bg-cream-200 shrink-0 border border-cream-300">
                        <Image
                          src={item.image}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                          <span className="inline-block text-[10px] font-semibold text-coral-600 bg-coral-100 px-1.5 py-0.5 rounded">
                            {item.variantName}
                          </span>
                          <span className="text-[11px] text-choco-600 font-bold">
                ...
                <div className="pt-4 border-t border-cream-300 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3.5 py-2.5 rounded-xl border text-xs text-choco-900 bg-cream-50/50 focus:bg-white focus:outline-none focus:ring-2 transition-all ${
                        formErrors.name
                  ...
                  {customer.deliveryMethod !== 'pickup' && (
                    <div className="p-3.5 rounded-2xl bg-amber-50/60 border border-amber-200/80 space-y-3 animate-fadeIn">
                      ...
                      <div className="flex items-center justify-between text-[11px] text-choco-700 font-medium">
                        <span className="flex items-center gap-1">
                          ...
                          Titik Toko: <strong className="text-choco-900">Jatinangor</strong>
                        </span>
                        <span className="text-[10px] bg-coral-100 text-coral-700 px-2 py-0.5 rounded-full font-bold">
                      ...
                      <button
                        ...
                        disabled={isLocating}
                        className="w-full py-2 px-3 rounded-xl bg-white hover:bg-cream-100 border border-coral-200 text-coral-700 text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-all"
                      >
                        {isLocating ? (
                          <>
                          ...
                          <>
                            ...
                            <span>📍 Gunakan Lokasi Saya (Hitung Jarak Otomatis)</span>
                          </>
                        )}
                      </button>

                      {gpsStatus && (
                        <p className="text-[11px] text-choco-700 bg-white/80 p-2 rounded-lg border border-cream-200 flex items-center gap-1.5">
                      ...
                      <div>
                        <label className="block text-[11px] font-bold text-choco-800 mb-1.5">
                          Atau Pilih Area Populer Sekitar Jatinangor:
                        </label>
                      ...
                      <div className="pt-2 border-t border-amber-200/60">
                        <div className="flex justify-between items-center mb-1">
                          <label className="text-[11px] font-bold text-choco-800 flex items-center gap-1">
                        ...
                        />
                        <div className="flex justify-between text-[10px] text-choco-500 mt-0.5">
                  ...
                  {customer.deliveryMethod !== 'pickup' && (
                    <div>
                      ...
                      <textarea
                        rows={2}
                        placeholder="Contoh: Kost Pondok Mawar No. 15, Jl. Sayang Jatinangor (Dekat Gerbang Belakang Unpad)"
                        ...
                        className={`w-full px-3.5 py-2 rounded-xl border text-xs text-choco-900 bg-cream-50/50 focus:bg-white focus:outline-none focus:ring-2 transition-all ${
                          formErrors.address
                            ? 'border-red-400 focus:ring-red-300'
                            : 'border-cream-300 focus:ring-coral-300 focus:border-coral-400'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Contoh: Minta ice pack atau tulis ucapan birthday"
          ...
          {items.length > 0 && (
            <div className="p-5 sm:p-6 bg-cream-100 border-t border-cream-300 space-y-3.5">
              
              {/* Summary Calculation Breakdown */}
              <div className="space-y-1.5 bg-white/70 p-3 rounded-xl border border-cream-300/70 text-xs">
                ...
                <div className="flex justify-between items-center text-choco-600">
                  <span className="flex items-center gap-1">
                    <span>Biaya Ongkir</span>
                    {customer.deliveryMethod !== 'pickup' && (
                      <span className="text-[10px] bg-coral-100 text-coral-700 px-1.5 py-0.2 rounded font-bold">
                ...
                <div className="pt-2 border-t border-cream-300 flex justify-between items-baseline">
                  <div>
                    <span className="font-display font-extrabold text-choco-900 text-sm sm:text-base block leading-tight">
                      Total Pembayaran
                    </span>
                    <span className="text-[10px] text-choco-500 font-medium">
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-sm shadow-lg hover:shadow-xl flex items-center justify-center gap-2 transition-all transform active:scale-98"
              >
                <Send className="w-4 h-4" />
                <span>Pesan Sekarang via WhatsApp</span>
              </button>

              <p className="text-[10px] text-center text-choco-500 font-medium">
